...
This file preserves the acceptance contract that was active before the
2026-07-10 RTX 4090 quality-first rewrite. It is historical evidence only.
Current acceptance requirements are defined in [criteria.md](criteria.md).
